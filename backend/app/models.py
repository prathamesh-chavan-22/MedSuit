...
class ChatSession(Base):
    ...
    messages = orm_relationship("ChatMessage", back_populates="session", cascade="all, delete-orphan", order_by="ChatMessage.created_at")
...
class ChatMessage(Base):
    ...
    session = orm_relationship("ChatSession", back_populates="messages")
